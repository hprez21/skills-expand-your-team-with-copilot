document.addEventListener("DOMContentLoaded", () => {
  ...
  // Get a normalized difficulty value for an activity
  function getActivityDifficulty(details) {
    const difficulty = String(details.difficulty_level || "").toLowerCase();
  ...
  function displayFilteredActivities() {
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      } else if (activityDifficulty !== currentDifficultyFilter) {
        return;
      }
      ...
      const searchableContent = [
        ...
        difficultyLabels[activityDifficulty]
          ? difficultyLabels[activityDifficulty].toLowerCase()
          : "",
      ].join(" ");
  ...
  function renderActivityCard(name, details) {
    ...
    const activityDifficulty = getActivityDifficulty(details);
    const difficultyText = difficultyLabels[activityDifficulty] || "";
    ...
    activityCard.innerHTML = `
      ...
      ${
        difficultyText
          ? `<p class="difficulty-level"><strong>Difficulty:</strong> ${difficultyText}</p>`
          : ""
      }
      <p class="tooltip">
